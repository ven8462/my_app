...
import { idlFactory } from './my_app_backend.did.js';
export { idlFactory } from './my_app_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MY_APP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_app_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_app_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_app_backend.did.js")._SERVICE>}
 */
export const my_app_backend = createActor(canisterId);
