...
import { idlFactory } from './my_app_frontend.did.js';
export { idlFactory } from './my_app_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MY_APP_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_app_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_app_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_app_frontend.did.js")._SERVICE>}
 */
export const my_app_frontend = createActor(canisterId);
